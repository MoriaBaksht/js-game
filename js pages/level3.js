...
const images = ["../img/one.png", "../img/two.png", "../img/three.png", "../img/four.png", "../img/five.png", "../img/six.png", "../img/seven.png", "../img/eight.png"]
const allImages = [...images, ...images]//display the images array two times
